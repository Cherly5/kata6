...
public class BoardTest {
    ...
    @Test
    public void should_return_2x2_board_with_all_alive_cells_given_1x1_board_with_all_alive_cell() {
    ...
    @Test
    public void should_return_2x2_board_with_all_alive_cells_given_1x1_board_with_triangle_structure() {
        Board board = new Board(Cases.board2x2_with_triangle_structure).next();
        assertThat(board.state()).isEqualTo(Cases.board2x2_with_all_alive_cells);
    }
    @Test
    public void should_return_2x2_board_with_all_dead_cells_given_1x1_board_with_strip_structure() {
